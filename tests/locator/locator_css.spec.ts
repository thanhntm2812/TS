...
test("Menu list > Store list - CSS", async ({ page }) => {
    ...
    const menuBGData = menuSidebar.locator('div[data-menu-id$="BACKGROUND_DATA"]');
    ...
    const searchForm = page.locator('div[class*="ant-pro-table-search-query-filter"]');
    ...
    const statusSelectBox = page.locator('span.ant-select-selection-item:has-text("Hoạt động")');
